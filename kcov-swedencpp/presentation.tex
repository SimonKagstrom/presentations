...
% Disassembly here
  ...
  \begin{Example}
    \begin{semiverbatim}
      \scriptsize
return (void*)op\_create(RPAR);
\textcolor{red}{400ff7}:       bf 30 00 00 00          mov    \$0x30,\%edi
...
40100d:       00 00 00
p\_state->last\_token\_is\_od = 0;
\textcolor{red}{401010}:       c7 43 08 00 00 00 00    movl   \$0x0,0x8(\%rbx)
return (void*)op\_create(op);
\textcolor{red}{401017}:       bf 04 00 00 00          mov    \$0x4,\%edi
