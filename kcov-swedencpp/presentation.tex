...
\begin{frame}
  \titlepage
  \note{My name is Simon Kågström and I work at Net Insight. Tonight I will present kcov, a code coverage collection and presentation tool for UNIX systems.
...
\begin{frame}[fragile]{Dwarf quirkls}
  \note{
    \footnotesize
